...
// Updated For version-89b6c70d8f7f42ac By ente0216
...
namespace offsets {
    ...
    constexpr std::uint64_t IsCoreScript = 0x1A0; 
    ...
    // Datamodel
    constexpr std::uint64_t FakeDatamodelPointer = 0x7022FA8;
    constexpr std::uint64_t FakeToRealDatamodel = 0x1C0;

    constexpr std::uint64_t EnableLoadModule = 0x5EA9320;
}
